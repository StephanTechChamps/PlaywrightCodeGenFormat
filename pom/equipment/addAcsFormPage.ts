...
export class AddAcsFormPage {
    ...
    async createACS(acsName: string, prefix: string, coordinatesX: number, coordinatesY: number, dimensionsLength: number, dimensionsWidth: number, orientation: number,
