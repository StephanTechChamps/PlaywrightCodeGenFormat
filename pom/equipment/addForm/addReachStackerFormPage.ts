...
export class AddReachStackerFormPage extends BaseFormPage {
    ...
    async createReachStacker(name: string, maxWeight: number, maxTierHeight: number, softwareVersion: string, coordinateX: number, coordinateY: number, orientation: number) {
