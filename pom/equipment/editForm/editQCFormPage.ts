...
export class EditQCFormPage extends BaseFormPage{
    ...
    async editQC(name: string, maxWeight: number, availableLocationOnPlatform: number, laneName: string, distanceToQ: number,
