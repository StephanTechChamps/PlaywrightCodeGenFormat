...
import {expectedDataForEquipmentARMG} from "../test-data/equipment/equipmentTestDataForARMG"
import {EquipmentTable} from "../pom/equipment/equipmentTable";
import {expectedDataForQC} from "../test-data/equipment/equipmentTestDataForQC";
import {expectedDataForEquipmentACS} from "../test-data/equipment/equipmentTestDataForACS";
import {equipmentTableRowDataForACS} from "../pom/equipment/interfaces/equipmentTableRowDataForACS";
import {expectedDataForEquipmentAGV} from "../test-data/equipment/equipmentTestDataForAGV";
import {expectedDataForReachStacker} from "../test-data/equipment/equipmentTestDataForReachStacker";
import {expectedDataForRemoteOperatingStation} from "../test-data/equipment/equipmentTestDataForRemoteOperatingStation";
...
test("Verify test data for A-RMG", async ({page}) => {
    ...
    await homePage.selectVehicleType(VehicleType.A_RMG);
    const actualData = await equipmentTable.getActualEquipmentTableDataForAMG();
